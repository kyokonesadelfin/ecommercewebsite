...
const Checkout = () => {
	...
	return (
		<>
			<div className="container my-5 mt-5 pt-5 pb-5 mb-5">
			<div className="row g-5">
			      <div className="col-md-5 col-lg-4 order-md-last">
			        <h4 className="d-flex justify-content-between align-items-center mb-3">
			          <span className="text-primary mt-4 pt-4">Your cart</span>
			      ...
			      <div className="col-md-7 col-lg-8 mt-5 pt-5">
			        <h4 className="mb-3">Billing address</h4>
			        <form className="needs-validation" novalidate="">
			          <div className="row g-3">
			            <div className="col-sm-6">
			              <label htmlFor="firstName" className="form-label">First name</label>
			              <input type="text" className="form-control" id="firstName" placeholder="" value="" required="" spellcheck="false" data-ms-editor="true" />
			            ...
			            <div className="col-sm-6">
			              ...
			              <input type="text" className="form-control" id="lastName" placeholder="" value="" required="" spellcheck="false" data-ms-editor="true"/>
			              <div className="invalid-feedback">
